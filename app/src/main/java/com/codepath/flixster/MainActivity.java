...
public class MainActivity extends AppCompatActivity {
    ...
    // tag for logging from MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get the configuration when the app is created and now playing
        getConfiguration();
    }
        ...
        client.get(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    logError("Failed to parse data from now_playing movies",
                            e, true);
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                logError("Failed to get data from now_playing movies", throwable, true);
            }
        });
